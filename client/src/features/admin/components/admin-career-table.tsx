      ...
      <Table>
        <TableHeader>
          <TableRow className="hover:bg-transparent border-b border-border/80">
            <TableHead className="text-muted-foreground text-xs">{t("career.columnId")}</TableHead>
            <TableHead className="text-muted-foreground text-xs">{t("career.columnName")}</TableHead>
            <TableHead className="text-muted-foreground text-xs">{t("career.columnCompany")}</TableHead>
            <TableHead className="text-muted-foreground text-xs">{t("career.columnStatus")}</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {isLoading ? (
