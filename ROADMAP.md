...
- [ ] **Xoá code chết sau khi xác nhận không còn import**
  📍 Grep lại reference trước khi xoá: `client/src/components/layout/dashboard-header.tsx`, `header.tsx`, `dashboard-sidebar.tsx`, `client/src/features/admin/components/admin-header.tsx`, `admin-sidebar.tsx`.
